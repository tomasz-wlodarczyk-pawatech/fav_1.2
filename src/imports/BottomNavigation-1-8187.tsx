import svgPaths from "./svg-847a84y13z";

function ProgressPercentage() {
  return (
    <div className="absolute inset-0" data-name="progress-percentage">
      <div className="absolute bg-[#8dc63f] bottom-0 left-0 right-full top-0" data-name="progress-surface" />
    </div>
  );
}
  ...
  return (
    <div className="basis-0 content-stretch flex grow items-start justify-start min-h-px min-w-px relative shrink-0" data-name="Body">
      <div className="basis-0 font-['Roboto:Bold',_sans-serif] font-bold grow leading-[0] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[#252a2d] text-[12px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="[text-overflow:inherit] [text-wrap-mode:inherit]\' [white-space-collapse:inherit] leading-[16px] overflow-inherit">1000% Win Bonus.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-6" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d="M4 12H20M4 18H20M4 6H20" id="Vector" stroke="var(--stroke-0, #AAAEB0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-6" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d={svgPaths.p23767f00} id="Vector" stroke="var(--stroke-0, #AAAEB0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="basis-0 content-stretch flex grow h-16 items-start justify-start min-h-px min-w-px relative shrink-0" data-name="ellipses">
      <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="left">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 64">
          <path d="M0 0C22.5 0 32 43 32 64H0V0Z" fill="var(--fill-0, #252A2D)" id="left" />
        </svg>
      </div>
      <div className="basis-0 flex grow h-full items-center justify-center min-h-px min-w-px relative shrink-0">
        <div className="flex-none rotate-[180deg] scale-y-[-100%] size-full">
          <div className="relative size-full" data-name="right">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 64">
              <path d={svgPaths.p1dc2bc00} fill="var(--fill-0, #252A2D)" id="right" />
            </svg>
          </div>
        </div>
      </div>
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-6" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d={svgPaths.p1694a480} id="Vector" stroke="var(--stroke-0, #AAAEB0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-6" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d={svgPaths.pea1e2e0} id="Vector" stroke="var(--stroke-0, #AAAEB0)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
