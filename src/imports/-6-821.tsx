import svgPaths from "./svg-oils74kz5b";
...
function CloseX() {
  return (
    <div className="bg-[#353b40] box-border content-stretch flex items-center justify-end p-[3px] relative rounded-[2px] shrink-0" data-name="close-x">
      <IconContent />
    </div>
  );
}

function Frame1261159458() {
  return (
...
function Frame1261158968() {
  return (
    <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-[195px]">
      <Megaphone />
      <Frame1261158881 />
    </div>
  );
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-0.5 grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#252a2d] text-[14px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[18px]">Free Callback</p>
      </div>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="bg-[#ffffff] relative shrink-0 w-full" data-name="Component 5">
...
export default function Component() {
  return (
    <div className="bg-[#f4f5f0] relative size-full" data-name="-">
      <div className="flex flex-col items-end relative size-full">
        <div className="box-border content-stretch flex flex-col gap-3 items-end justify-start pb-8 pt-3 px-3 relative size-full">
          <Frame1261159458 />
          <Frame1261158941 />
        </div>
      </div>
